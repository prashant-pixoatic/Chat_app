...
ActiveRecord::Schema[8.0].define(version: 2025_03_25_060249) do
  ...
  create_table "voice_messages", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["group_id"], name: "index_voice_messages_on_group_id"
    t.index ["receiver_id"], name: "index_voice_messages_on_receiver_id"
  ...
  add_foreign_key "voice_messages", "groups"
